		...
		<section id="content">
			<div class="marg_top wrapper">
				...
				<article class="col1">
					<div class="box1_out">
						<div class="box12">
						<form name="login" method="POST" action="link.php">
						<br/><br/>
							Emp/User Id:<input type="text" name="username" id="username"/>
							<br/><br/><br/><br/>
							Password:&nbsp;&nbsp;&nbsp;&nbsp;<input  type="password" name="password" id="password"/>
							<br/><br/>
							<input type="submit" class="button" type="submit" value="Log In"/><span><span></span></span></form>
						</div>
					</div>
					<div class="box1_bot"><div class="box1_bot_left"><div class="box1_bot_right"></div></div></div>
				</article>
