        ...
        <div class="boxl">
			...
			<table width="600" style="margin-left: 25px;" class="leaveap">
				...
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11">Leave Request page</td>
						
					</tr>
				
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11"><a href="leaveapplication.php?id="<?php $_COOKIE['username'];?>>Leave Application</a></td>
				</tr>
				
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11"><a href="leavecancellation.php?id="<?php $_COOKIE['username'];?>">Leave Cancellation</a></td>
				</tr>
				
				
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11"><a href="viewappliedleave.php">View Applied leave</a></td>
				</tr>
