...
<div id="mainl">
        <div class="boxl">
            <div class="paddingl">
			<form name="lereply" action="lereply.php" method="POST">
...
while($row = mysql_fetch_array($result))
  ...
  echo "<br />";
				...
				<tr height="50" class="r1">
					<td class="d1">To</td><td class="d1">
						Manager
					</td><td></td>
				</tr>
				
				<tr height="50" class="r1">
					<td class="d1">Reply</td><td class="d1">
						<textarea></textarea>
					</td><td></td>
				</tr>
				
				<tr height="50" class="r1">
					<td class="d1"></td><td class="d1"><input type="submit" value="submit"/></td><td></td>
				</tr>
			</table>
		</form>
			</div>
