...
$rs=mysql_query("select * from leavecancel where apname='$appname'");
if (mysql_num_rows($rs)>0)
{

echo("<script type='text/javascript'>
	alert('You are already applied to cancel a leave!')		
...
while($row = mysql_fetch_array($result))
  ...
  echo "<br />";
				...
				<tr height="50" class="r1">
					<td class="d1">Cancel From</td><td class="d1"><input type="text" name="cancelfrom" id="cancelfrom"/>
						<a href="javascript:NewCal('cancelfrom','ddmmmyyyy')">
						
					<img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
					
					</td><td class="d15">To</td><td class="d1"><input type="text" name="cancelto" id="cancelto"/>
						<a href="javascript:NewCal('cancelto','ddmmmyyyy')">
						
					<img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
					</td>
				</tr>
				<tr height="50" class="r1">
					<td class="d1">Approved By</td><td class="d1"><input type="text" name="approvedby" id="approvedby"/></td><td></td>
				</tr>
				<tr height="50" class="r1">
					<td class="d1">Reason</td><td class="d1"><textarea name="reason" id="reason"></textarea></td><td></td>
				</tr>
				
				<tr height="50" class="r1">
					<td class="d1"></td><td class="d1"><input type="submit" class="button" name="submit" value="submit"/>&nbsp;<!--<input type="submit" value="clear"/>--></td><td></td>
				</tr>
			</table>
		</form>
			</div>
