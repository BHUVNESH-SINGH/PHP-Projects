...
if(isset($submit))
{
	$rs=mysql_query("select * from employees where loginid='$username' and password='$password'");
		...
		<section id="content">
			<div class="marg_top wrapper">
				<article class="col1">
					<div class="box1_out">
						<div class="box1">
							<h2>Welcome-<?php echo htmlentities($_SESSION['login'], ENT_QUOTES, 'UTF-8'); ?></h2>
							<p class="pad_bot1">
