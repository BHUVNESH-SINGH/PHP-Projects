        ...
        <div class="boxl">
			...
			<table width="600" style="margin-left: 25px;" class="leaveap">
				...
				<tr height="50" class="r1" style="background-color: #ffffff;">
					...
					<?php
							$result = mysql_query("SELECT * FROM leaveapply");

while($row = mysql_fetch_array($result))
  {
  echo'<tr height="50" class="r12" style="background-color: #ffffff;">
					<td class="d112"><a href="viewleaverequest.php?apname='.$row['apname'].'">'.$row['apname'].'</a></td>
				...
				<!--
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11"><a href="leaveapplication.php">Leave Application</a></td>
				</tr>
				
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11"><a href="leavecancellation.php">Leave Cancellation</a></td>
				</tr>
				
				
				<tr height="50" class="r1" style="background-color: #ffffff;">
					<td class="d11">Verification and Approved</td>
				</tr>-->
